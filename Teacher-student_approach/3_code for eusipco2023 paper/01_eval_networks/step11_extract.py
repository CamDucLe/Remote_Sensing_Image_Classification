...
from tensorflow.keras.applications import DenseNet201, Xception, NASNetLarge, NASNetLarge, VGG19, InceptionV3, MobileNetV2, ResNet50V2, MobileNet, VGG16, EfficientNetB4,  EfficientNetB7
...
def main():
    ...
    with strategy.scope():
        ...
        if os.path.isfile(best_model_file):
            ...
            ### x1 = MultiHeadAttention(num_heads=16, key_dim=128)(x1, x1)
            ### x2 = MultiHeadAttention(num_heads=16, key_dim=128)(x2, x2)
