...
class generator(object):
    ...
    def __init__(self, train_dir, test_dir):  
        ...
        self.test_file_id   = np.random.RandomState(seed=42).permutation(self.get_file_num(self.test_dir))
    ...
    def get_batch (self, batch_num, batch_size, is_mixup, is_train):
        if is_train:
            ...
            file_list    = self.get_file_list(self.test_dir)
    ...
    def mixup_aug(self, i_data, i_label, beta=0.4):
        ...
        b = np.random.uniform(0.1, 0.3, half_batch_size)
